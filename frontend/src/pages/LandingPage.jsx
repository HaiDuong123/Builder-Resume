                ...
                <div className={landingPageStyles.heroGrid}>
                    ...
                    <div className={landingPageStyles.heroLeft}>
                        ...
                        <div className={landingPageStyles.ctaButtons}>
                            ...
                            <button 
    // Thêm hover:scale-105 (phóng to) và chỉnh lại màu nền/viền khi hover cho đậm đà hơn
    className={`${landingPageStyles.secondaryButton} hover:scale-105 hover:shadow-lg hover:border-violet-400 hover:bg-violet-100`} 
    onClick={handleCTA}
>
    View Templates
</button>
                        ...
                        <div className={landingPageStyles.ctaCard}>
                            ...
                            <div className={landingPageStyles.ctaCardContent}>
                                ...
                                <p className={landingPageStyles.ctaDescription}>
                                    Join thousands of professionals who landed thier dream jobs with our platform
                                </p>
        ...
        <footer className={landingPageStyles.footer}>
            <div className={landingPageStyles.footerContainer}>
                <p className={landingPageStyles.footerText}>
                    ...
                    <a href="https://github.com/HaiDuong123?tab=repositories" target='_blank' className={landingPageStyles.footerLink}>
                        Duong Ngo GitHub
                    </a>
                </p>
