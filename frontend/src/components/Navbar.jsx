...
const Navbar = () => {
    return (
        <div className=' h-16 bg-white/70 backdrop-blur-xl border-border-violet-100/50 py-2.5 px-4 md:px-0 sticky top-0 z-50 '>
                <div className=' max-w-6xl mx-auto flex items-center justify-between gap-5'>
                    ...
                    <div className=' flex items-center pb-6 gap-3'>
                        <div className=' w-10 h-10 bg-gradient-to-r from-violet-600 to-fuchsia-600 rounded-2x1 flex items-center justify-center shadow-1g shadow-violet-200'>
