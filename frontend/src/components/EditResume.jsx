...
// Thêm dòng này vào đầu file EditResume.jsx (cùng chỗ với các import khác)
import './A4.css';
...
const handleDeleteResume = async () => {
  ...
  const downloadPDF = async () => {
    ...
    //type of how it will look when downloading
    try {
      await html2pdf()
        .set({
          margin:       0,
  ...
  return (
    <DashboardLayout>
            ...
            <div className={containerStyles.previewContainer}>
              <div className=" text-center mb-4">
                <div className={statusStyles.completionBadge}>
                  ...
                  <span>
                    Preview - {completionPercentage}% Complete</span>
                </div>
              </div>
      ...
      <Modal isOpen={openPreviewModal} onClose={() => setOpenPreviewModal(false)}
        ...
        showActionBtn
        actionBtnText={isDownloading ? "Generationg..."
      ...
      {/* Thay display: none bằng style đẩy ra khỏi màn hình */}
<div style={{ position: "absolute", left: "-9999px", top: "-9999px" }} ref={thumbnailRef}>
